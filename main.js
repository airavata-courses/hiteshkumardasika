function makeFbLogin() {
    ...
    var url = "http://129.114.104.33:8084/apigateway-1/fb/" + un + "/" + pw;
    /*
...
function registerUser() {
    ...
    var url = "http://129.114.104.33:8084/apigateway-1/fb";
    $.ajax({
        headers: {
            'Content-Type': 'application/json'
        },
...
function insertItem() {
    ...
    $.ajax({
        ...
        url: "http://129.114.104.33:8084/apigateway-1/fb/item",
        type: 'POST',
...
function fetchAllItems(userId) {
    $.ajax({
        url: "http://129.114.104.33:8084/apigateway-1/fb/item/" + userId,
        type: 'GET',
        success: function success(data) {
...
function deleteItem() {
    ...
    $.ajax({
        url: "http://129.114.104.33:8084/apigateway-1/fb/item/" + itemId,
        type: 'DELETE',
        success: function success(data) {
            fetchAllItems(sessionStorage.getItem("userId"))
        }
